...
jumbotron = dbc.Jumbotron(
    html.Div([
    html.H4("Telecom Customer Churn Prediction and Analysis"),
    html.H5("Team Members: ",style={'textAlign': 'center'}),
    html.H6("1. Anurag Reddy Neravetla",style={'textAlign': 'center'}),
    html.H6("2. Gayathri Katukojwala",style={'textAlign': 'center'}),
    html.H6("3. Mayur Iswarbhai Vora",style={'textAlign': 'center'}),
    html.H6("4. Sai Sri Harsha Chakravarthula",style={'textAlign': 'center'})
    ]),
    className="cover"
)
